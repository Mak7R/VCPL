...
public static class BasicMath
{
    ...
    public static object Plus(object a, object b)
    {
        ...
        if (a is char chara && b is char charb) return chara + charb;
        if (a is int stringa && b is int stringb) return stringa + stringb;
        
        if (a is int intda && b is double doubleib) return intda + doubleib;
        if (a is double doubleia && b is double intdb) return doubleia + intdb;
